...
The best place to start is to check the [issues](https://github.com/sanders41/message-sender/issues)
...
1. A short, self-contained Python snippet reproducing the problem. You can format the code by using
   ...
   with GoogleChatClient("https://url.com") as client:
...
```sh
git clone https://github.com/your-user-name/message-sender.git
cd message-sender
git remote add upstream https://github.com/sanders41/message-sender.git
```

This creates the directory message-sender and connects your repository to the upstream (main project)
repository.
...
[main github page](https://github.com/sanders41/message-sender).
...
After pushing your code to origin it is now on GitHub but not yet part of the message-sender
...
of the message-sender project know you have code ready to be reviewed. To submit the pull request:
...
There may be some merge conflicts that need to be resolved. After the feature branch has been
updated locally, you can now update your pull request by pushing to the branch on GitHub:
